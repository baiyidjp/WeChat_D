...
static JPTextChangeToPinYinManager *manager;

@implementation JPTextChangeToPinYinManager
...
+ (instancetype)sharedManager{
    ...
    dispatch_once(&onceToken, ^{
        manager = [[JPTextChangeToPinYinManager alloc]init];
    });
    return manager;
}
...
+ (NSString *)getPinYinFromText:(NSString *)text{
    ...
    NSData *gb2312_data = [text dataUsingEncoding:enc];
